...
class ArticleDatabaseHelper {
    ...
    public ArticleDatabaseHelper(Connection connection) {
...
public boolean checkInAdmin(String group, String newAdmin) throws SQLException {
    ...
    String s="";
        ...
        String[] articleList = articlesFromGroups(backupGroups);  // Get the list of article titles
        ...
        while (rs.next()) {
            ...
            for (String article : articleList) {//check if the article's title matches any of the groups in articleList
